...
self.addEventListener('install', function (e) {
  ...
  // can hand back its own stale copy of a file we just changed, and that stale
  // copy gets baked into the new cache — leaving her phone on an old version of
  // the app with no way to notice.
